...
FSharpMap.prototype.GetHashCode = function () {
  ...
  while (e$$1.MoveNext()) {
    ...
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3539[0]));
    res$$3 = combineHash(res$$3, structuralHash(activePatternResult3539[1]));
  }
...
export function createMutable(source$$5, comparer$$23) {
  ...
  iterate$$1(function (forLoopVar) {
    MutableMap$002400602$0024$0024Add$0024$00245BDDA1(map$$1, forLoopVar[0], forLoopVar[1]);
  }, source$$5);
  return map$$1;
}
