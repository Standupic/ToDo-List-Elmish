...
export function MutableMap$00602$$TryFind$$2B595(this$$$1, k$$1) {
  ...
  switch ($target$$10) {
    case 0:
      {
        return getItemFromDict(this$$$1["entries@23"], matchValue$$1[1])[matchValue$$1[2]];
      }
...
export function MutableMap$00602$$set_Item$$5BDDA1(this$$$6, k$$3, v) {
  ...
  switch ($target$$20) {
    case 0:
      {
        getItemFromDict(this$$$6["entries@23"], matchValue$$3[1])[matchValue$$3[2]] = [k$$3, v];
        break;
      }
    ...
    case 1:
      {
        if (matchValue$$3[0]) {
          const value = getItemFromDict(this$$$6["entries@23"], matchValue$$3[1]).push([k$$3, v]);
          null, null;
        } else {
...
export function MutableMap$00602$$Add$$5BDDA1(this$$$7, k$$4, v$$1) {
  ...
  switch ($target$$24) {
    ...
    case 1:
      {
        if (matchValue$$4[0]) {
          const value$$1 = getItemFromDict(this$$$7["entries@23"], matchValue$$4[1]).push([k$$4, v$$1]);
          null, null;
        } else {
...
export function MutableMap$00602$$Remove$$2B595(this$$$9, k$$6) {
  ...
  switch ($target$$30) {
    case 0:
      {
        getItemFromDict(this$$$9["entries@23"], matchValue$$6[1]).splice(matchValue$$6[2], 1);
        return true;
      }
