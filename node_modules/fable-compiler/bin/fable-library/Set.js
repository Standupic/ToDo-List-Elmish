...
import { delay, collect, empty as empty$$1, singleton as singleton$$1, iterate as iterate$$1, fold as fold$$1, toIterator, map as map$$1, reduce, getEnumerator, unfold } from "./Seq.js";
...
export function createMutable(source, comparer$$32) {
  ...
  iterate$$1(function (item) {
    const value = MutableSet$002400601$0024$0024Add$0024$00242B595(set, item);
    value, null;
  }, source);
  return set;
}
export function distinct(xs, comparer$$33) {
  return delay(function () {
    const set$$1 = MutableSet$002400601$0024$0024$0024$0024002Ector$0024$0024Z79760D57(comparer$$33);
...
export function distinctBy(projection, xs$$1, comparer$$34) {
  return delay(function () {
    const set$$2 = MutableSet$002400601$0024$0024$0024$0024002Ector$0024$0024Z79760D57(comparer$$34);
